sap.ui.define([
    ...
    return PluginPropertyEditorExtension.extend("rits.custom.plugin.operationpodselection.operationPodSelectionExtensionProvider.PropertyEditorExtension", {
        ...
        addPropertyEditorContentBefore: function (oPropertyFormContainer, oPropertyData) {
            ...
            if (oPropertyEditor) {
                ...
                oSwitch = oPropertyEditor.addSwitch(oPropertyFormContainer, "showStatusFilter", oPropertyData);
                iIndex = oPropertyFormContainer.indexOfContent(oSwitch);
                aContent = oPropertyFormContainer.getContent();
                if (aContent[iIndex-1].setText) {
                    oLabel = aContent[iIndex-1];
                    oLabel.setText("Show Status Filter");
                }
            }
        },
        ...
        getPropertyData: function (oPropertyData) {
            ...
            if (typeof oPropertyData.showStatusFilter === "undefined") {
                oPropertyData.showStatusFilter = true;
            }
